 ...
 */
export function createApp(authController: AuthController, profileController: ProfileController): Express {
  const app = express();

  app.use(cors({ origin: env.corsOrigin }));
  app.use(express.json());

  app.use(buildRouter(authController, profileController));
